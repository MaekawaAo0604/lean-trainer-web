...
function complex(args) {
  ...
  const complex2 = backend.texData.get(complexInfo.dataId);
...
function concatImpl(inputs, axis, backend) {
  ...
  if (dtype === "complex64") {
    ...
    const result2 = complex({ inputs: { real: realConcated, imag: imagConcated }, backend });
  ...
  if ($inputs.length > maxTexturesInShader) {
    ...
    const result2 = concatImpl(reducedInputs, axis, backend);
...
var ELU_PACKED = `
  ...
  return result;
`;
var elu = unaryKernelFunc({ opSnippet: ELU3, packedOpSnippet: ELU_PACKED });
var eluConfig = {
  kernelName: Elu,
  backendName: "webgl",
  kernelFunc: elu
...
var RELU_PACKED = `
  ...
  return result;
`;
var relu = unaryKernelFunc({ opSnippet: RELU3, packedOpSnippet: RELU_PACKED });
var reluConfig = {
  kernelName: Relu,
  backendName: "webgl",
  kernelFunc: relu
...
var RELU6_PACKED = `
  ...
  return result;
`;
var relu6 = unaryKernelFunc({ opSnippet: RELU63, packedOpSnippet: RELU6_PACKED });
var relu6Config = {
  kernelName: Relu6,
  backendName: "webgl",
  kernelFunc: relu6
